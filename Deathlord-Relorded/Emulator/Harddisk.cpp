...
// Debugger stripped — inline no-op stubs replace its DMA breakpoint hooks.
static inline void DebuggerBreakOnDmaToOrFromIoMemory(WORD, bool) {}
static inline bool DebuggerCheckMemBreakpoints(WORD, UINT, bool) { return false; }
