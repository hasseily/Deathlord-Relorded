...
UINT8 m_JoystickCenteringControl	= JOYSTICK_MODE_CENTERING;
bool m_JoystickCursorControl		= true;
bool m_JoystickAutofire				= true;
//
...
BOOL JoyProcessKey(int virtkey, bool extended, bool down, bool autorep)
{
	...
	const bool swapButtons0and1 = false;
	...
	else if ((down && !autorep) || (m_JoystickCenteringControl == JOYSTICK_MODE_CENTERING))
	{
		int xkeys  = 0;
		int ykeys  = 0;
		int xtotal = 0;
	...
	if (bIsCursorKey && m_JoystickCursorControl)
	{
